...
const ComboboxStrategy = ({strategyBox,tierList})=> {
    ...
    //    strategyTier = ["GOLD","PLATINUM","DIAMOND","MASTER","CHALLENGER"];
    // }
    // if(strategyBox.summonerTier==="PLATINUM"){
    //    strategyTier = ["PLATINUM","DIAMOND","MASTER","CHALLENGER"];
    // }
    // if(strategyBox.summonerTier==="DIAMOND"){
    //    strategyTier = ["DIAMOND","MASTER","CHALLENGER"];
    // }
    // if(strategyBox.summonerTier==="MASTER"){
    //    strategyTier = ["MASTER","CHALLENGER"];
    // }
    // if(strategyBox.summonerTier==="CHALLENGER"){
    //    strategyTier = ["CHALLENGER"];
    // }
